...
class ScraperConfig:
    ...
    def __init__(self, parameters: dict[str, Any] | None = None):
        ...
        config_file = self._get_config(
            default_value=SRAPER_CONFIG_FILE,
        ...
        if config_file == SRAPER_CONFIG_FILE:
            logger.debug(
                f"No Config File path provided, using default Config File path: {SRAPER_CONFIG_FILE}."
            )
        ...
        self.decode_guide_file = ScraperConfig._get_config(
