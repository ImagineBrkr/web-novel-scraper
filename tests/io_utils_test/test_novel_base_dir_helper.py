...
class TestGetNovelBaseDirFromMeta:
    ...
    def test_get_novel_base_dir_success(self, base_novels_dir, meta_file):
        ...
        meta_data = {
            "Test Novel": {"novel_base_dir": "/path/to/novel"}
        }
    ...
    def test_get_novel_base_dir_multiple_novels(self, base_novels_dir, meta_file):
        ...
        result1 = NovelBaseDirHelper.get_novel_base_dir_from_meta("Novel 1", str(base_novels_dir))
        result2 = NovelBaseDirHelper.get_novel_base_dir_from_meta("Novel 2", str(base_novels_dir))
        result3 = NovelBaseDirHelper.get_novel_base_dir_from_meta("Novel 3", str(base_novels_dir))
        
        assert result1 == "/path/to/novel1"
        assert result2 == "/path/to/novel2"
        assert result3 == "/path/to/novel3"

    def test_get_novel_base_dir_not_found_returns_none(self, base_novels_dir, meta_file):
    ...
    def test_get_novel_base_dir_empty_meta_returns_none(self, base_novels_dir, meta_file):
    ...
    def test_get_novel_base_dir_missing_novel_base_dir_field_returns_none(self, base_novels_dir, meta_file):
    ...
    def test_get_novel_base_dir_null_value_returns_none(self, base_novels_dir, meta_file):
        """Test when novel_base_dir is null returns None."""
        meta_data = {
            "Novel 1": {"novel_base_dir": None}
        }
        meta_file.write_text(json.dumps(meta_data))
    ...
    def test_get_novel_base_dir_special_characters_in_title(self, base_novels_dir, meta_file):
        """Test with special characters in novel title."""
        title = "Novel (Chinese Edition) - Chapter 1/2 [Updated]"
        meta_data = {
            title: {"novel_base_dir": "/path/to/novel"}
        }
        meta_file.write_text(json.dumps(meta_data))
        
        result = NovelBaseDirHelper.get_novel_base_dir_from_meta(title, str(base_novels_dir))
...
class TestSaveNovelDirToMeta:
    ...
    def test_save_multiple_novels(self, base_novels_dir):
        ...
        NovelBaseDirHelper.save_novel_dir_to_meta("Novel 1", "/path/1", str(base_novels_dir))
        NovelBaseDirHelper.save_novel_dir_to_meta("Novel 2", "/path/2", str(base_novels_dir))
        NovelBaseDirHelper.save_novel_dir_to_meta("Novel 3", "/path/3", str(base_novels_dir))
    ...
    def test_save_novel_overwrites_existing(self, base_novels_dir):
        ...
        NovelBaseDirHelper.save_novel_dir_to_meta("Novel 1", "/path/old", str(base_novels_dir))
        NovelBaseDirHelper.save_novel_dir_to_meta("Novel 1", "/path/new", str(base_novels_dir))
...
class TestGenerateNovelBaseDir:
    ...
    def test_generate_same_title_produces_same_path(self, tmp_path):
        ...
        result1 = NovelBaseDirHelper.generate_novel_base_dir("Same Novel", str(tmp_path))
        result2 = NovelBaseDirHelper.generate_novel_base_dir("Same Novel", str(tmp_path))
...
class TestNovelBaseDirHelperIntegration:
    ...
    def test_generate_save_and_retrieve(self, base_novels_dir):
        ...
        # Generate
        generated_path = NovelBaseDirHelper.generate_novel_base_dir(title, str(base_novels_dir))
        
        # Save
        NovelBaseDirHelper.save_novel_dir_to_meta(title, generated_path, str(base_novels_dir))
    ...
    def test_complex_workflow_multiple_novels(self, base_novels_dir):
        ...
        for novel in novels:
            path = NovelBaseDirHelper.generate_novel_base_dir(novel, str(base_novels_dir))
            NovelBaseDirHelper.save_novel_dir_to_meta(novel, path, str(base_novels_dir))
        
        for novel in novels:
            result = NovelBaseDirHelper.get_novel_base_dir_from_meta(novel, str(base_novels_dir))
