...
def guide_file(tmp_path):
    ...
    guide = [
        {
            "host": "test.com",
            "title": {"element": "h2", "extract": {"type": "text"}},
            "content": {"element": "div", "class": "epcontent", "array": True},
            "index": {
...
def guide_file_title_in_content(tmp_path):
    ...
    guide = [
        ...
        {"host": "example_yes.com", "title_in_content": "YES"},
        {"host": "example_search.com", "title_in_content": "SEARCH"},
        {"host": "example_no.com", "title_in_content": "NO"},
        {"host": "example_wrong.com", "title_in_content": "WRONG"},
    ]
...
def test_title_in_content_variations(
    guide_file_title_in_content, host, expected_option
):
    """
...
@pytest.mark.parametrize(
    "title_option,html,expected_startswith",
    [
        (
...
def test_get_chapter_content_variations(
    guide_file, title_option, html, expected_startswith
):
    """
